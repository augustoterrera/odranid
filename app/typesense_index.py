...
def collection_schema(name: str) -> dict[str, Any]:
    ...
    return {
        ...
        "fields": [
            ...
            {"name": "largo_m", "type": "float", "optional": True},
            {"name": "rendimiento_m2", "type": "float", "optional": True},
            {"name": "diametro_mm", "type": "float", "optional": True},
            {"name": "largo_manguera_m", "type": "float", "optional": True},
